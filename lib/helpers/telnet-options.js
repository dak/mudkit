...
export const TELNET_OPTIONS = {
    ...
    SEND_URL            : 48,
    FORWARD_X           : 49,
    MSDP                : 69, // MUD Server Data Protocol https://tintin.mudhalla.net/protocols/msdp/
    ...
    GMCP                : 201, // Generic Mud Communication Protocol https://mudhalla.net/tintin/protocols/gmcp/
    EXOPL               : 255 // RFC 861 (Extended-Options-List)
};

export const TTYPE_OPTIONS = {
    IS:   0,
    SEND: 1
};

export const MSSP_OPTIONS = {
    MSSP_VAR: 1,
    MSSP_VAL: 2
}

// TODO: Figure out how to deal with duplicate byte values
export const NEW_ENVIRON_OPTIONS = {
    IS:   0,
    SEND: 1,
    INFO: 2,
...
export const TTYPE_OPTION_NAMES = Object.keys(TTYPE_OPTIONS).reduce((out, key) => {
    const value = TTYPE_OPTIONS[key];
...
export const MSSP_OPTION_NAMES = Object.keys(MSSP_OPTIONS).reduce((out, key) => {
    const value = MSSP_OPTIONS[key];
