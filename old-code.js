    ...
    function processCommand () {
        ...
        function processSB () {
            ...
            case TTYPE:
                ...
                if (TELQUAL_SEND === chunk[i+1]) {
                    ...
                    mudkit.sendCommand([SB, TTYPE, TELQUAL_IS, term, IAC, SE].flatten());
                }
                break;
        ...
        case DO:
            ...
            case TTYPE:
                ...
                mudkit.sendCommand([WILL, TTYPE]);
                break;

            case NAWS:
                console.log('DO NAWS');
                mudkit.sendCommand([WILL, NAWS]);
            ...
            case MXP:
                console.log('DO MXP');
                mudkit.sendCommand([WONT, MXP]);
                break;

            case NEW_ENVIRON:
                console.log('DO NEW_ENVIRON');
                mudkit.sendCommand([WONT, NEW_ENVIRON]);
                break;
        ...
        case WILL:
            ...
            case ECHO:
                ...
                mudkit.sendCommand([DO,ECHO]);
                break;

            case COMPRESS2:
                console.log('WILL COMPRESS2');
                mudkit.sendCommand([DO, COMPRESS2]);
                break;
            case MSSP:
                console.log('WILL MSSP');
                mudkit.sendCommand([DONT, MSSP]);
                break;
            case ZMP:
                console.log('WILL ZMP');
                mudkit.sendCommand([DONT, ZMP]);
                break;
            case GCMP:
...
MUDKit.prototype.windowSize = function (size) {
    ...
    if (this.state.naws) {
        this.sendCommand([SB, NAWS, this.env.terminal.cols, this.env.terminal.rows, IAC, SE].flatten());
    }
};
